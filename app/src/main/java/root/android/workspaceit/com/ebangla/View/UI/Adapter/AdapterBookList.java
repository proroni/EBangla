...
public class AdapterBookList extends RecyclerView.Adapter<AdapterBookList.BookViewHolder> {
    ...
    public AdapterBookList(Context context, List<Books> bookList) {
    ...
    public void onBindViewHolder(BookViewHolder holder, int position) {
        ...
        //get Book Image
        //drawable = context.getResources().getDrawable(book.imageId());
    ...
    class BookViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("bookData",bookList.get(getAdapterPosition()));
